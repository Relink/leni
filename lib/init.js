 ...
 * @param {Array or Object} consumerOptions in the format: { payloads: Object, options: object }.
...
init.createStream = function createStream (client, producer, consumerOptions) {
  ...
  // coerce consumerOptions into array if not already
  consumerOptions = [].concat(consumerOptions);
